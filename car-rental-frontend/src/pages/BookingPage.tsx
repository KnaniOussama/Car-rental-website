...
const BookingPage: React.FC<BookingPageProps> = ({ isAuthenticated }) => {
  ...
  const [insurance, setInsurance] = useState<"full" | "basic" | "none">(
    "basic"
  );
  ...
  const totalPrice = useMemo(() => {
    ...
    const totalDailyCost =
      pricePerDay + optionsPricePerDay + insurancePricePerDay;
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      toast.success(
        "Booking successful! You will be redirected to the home page."
      );
      setTimeout(() => {
        ...
        <div className="lg:col-span-7">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select your options and enter your information to complete the
                booking.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Checkbox
                      id="driver"
                      checked={options.driver}
                      onCheckedChange={() => handleOptionChange("driver")}
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={() => handleOptionChange("fuel")}
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="font-semibold">
                      ${optionPrices.infantSeat}
                    </span>
                    <Checkbox
                      id="infantSeat"
                      checked={options.infantSeat}
                      onCheckedChange={() => handleOptionChange("infantSeat")}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <RadioGroup
                  value={insurance}
                  onValueChange={(value) => setInsurance(value as any)}
                >
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <Label htmlFor="full-insurance" className="flex-grow">
                      Full Insurance
                    </Label>
                    <span className="font-semibold mr-4">
                      ${insurancePrices.full}
                    </span>
                    <RadioGroupItem value="full" id="full-insurance" />
                  </div>
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <Label htmlFor="basic-insurance" className="flex-grow">
                      Basic Insurance
                    </Label>
                    <span className="font-semibold mr-4">
                      ${insurancePrices.basic}
                    </span>
                    <RadioGroupItem value="basic" id="basic-insurance" />
                  </div>
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <Label htmlFor="no-insurance" className="flex-grow">
                      No Insurance
                    </Label>
                    <span className="font-semibold mr-4">
                      ${insurancePrices.none}
                    </span>
